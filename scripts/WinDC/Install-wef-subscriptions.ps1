<#  
    .SYNOPSIS  
    Installs the wef subscriptions on the Windows Server DC

    .DESCRIPTION  
    Author: Chris Long (@Centurion)

    Imports the custom Windows Event Channel and XML subscriptions on Windows Server DC (also WEF host)
