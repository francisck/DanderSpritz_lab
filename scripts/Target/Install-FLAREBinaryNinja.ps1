<#  
    .SYNOPSIS  
    Installs Binary Ninja from the Internet via Chocolatey (FLARE). 
    ...
    Performs a standard chocolatey installation of the most recent stable version of Binary Ninja. 
...
[String]$PackageName = "binaryninja"
[Int]$RetryCounter = 0
[Int]$RetryMax = 3 
[Int]$SleepCounter = 30
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\binaryninja.lnk")
    $Shortcut.TargetPath = "C:\Program Files\Vector35\BinaryNinja\binaryninja.exe"
    $Shortcut.Save()
}
Catch 
{
