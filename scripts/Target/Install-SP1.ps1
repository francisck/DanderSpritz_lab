...
Try 
{
    (New-Object System.Net.WebClient).DownloadFile('http://172.28.128.3/KB976932-X64.exe', 'C:\Windows\Temp\KB976932-X64.exe')   
    ...
    #cmd /c C:\Windows\Temp\KB976932-X64.exe /quiet /nodialog /norestart
}
Catch 
{
