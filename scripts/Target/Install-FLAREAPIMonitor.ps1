...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\API Monitor.lnk")
    $Shortcut.TargetPath = "C:\ProgramData\chocolatey\lib\apimonitor\tools\API Monitor (rohitab.com)"
    $Shortcut.Save()
}
Catch 
{
