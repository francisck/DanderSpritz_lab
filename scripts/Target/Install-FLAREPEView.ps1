<#  
    .SYNOPSIS  
    Installs PEVIEW from the Internet via Chocolatey. 
    ...
    Performs a standard chocolatey installation of the most recent stable version of PEVIEW. 
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\PEview.lnk")
    $Shortcut.TargetPath = "C:\ProgramData\chocolatey\lib\peview\tools\PEview.exe"
    $Shortcut.Save()
}
Catch 
{
