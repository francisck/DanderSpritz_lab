<#  
    .SYNOPSIS  
    Installs HXD from the Internet via Chocolatey. 
    ...
    Performs a standard chocolatey installation of the most recent stable version of HXD. 
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\HxD.lnk")
    $Shortcut.TargetPath = "C:\Program Files (x86)\HxD\HxD.exe"
    $Shortcut.Save()
}
Catch 
{
