<#  
    .SYNOPSIS  
    Installs HashCalc from the Internet via Chocolatey (FLARE). 
    ...
    Performs a standard chocolatey installation of the most recent stable version of HashCalc. 
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\HashCalc.lnk")
    $Shortcut.TargetPath = "C:\Program Files (x86)\HashCalc\HashCalc.exe"
    $Shortcut.Save()
}
Catch 
{
