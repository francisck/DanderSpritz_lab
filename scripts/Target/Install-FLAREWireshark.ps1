<#  
    .SYNOPSIS  
    Installs WireShark from the Internet via Chocolatey (FLARE). 
    ...
    Performs a standard chocolatey installation of the most recent stable version of WireShark. 
...
[String]$PackageName = "vcredist2015"
[Int]$RetryCounter = 0
[Int]$RetryMax = 3 
[Int]$SleepCounter = 30
...
[String]$PackageName = "wireshark.flare"
[Int]$RetryCounter = 0
[Int]$RetryMax = 3 
[Int]$SleepCounter = 30
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\Wireshark.lnk")
