<#  
	.SYNOPSIS  
	Installs Sysinternals from the Internet via Chocolatey. 
	...
	Performs a standard chocolatey installation of the most recent stable version of Sysinternals. 
...
[String]$PackageName = "sysinternals"
[Int]$RetryCounter = 0
[Int]$RetryMax = 3 
[Int]$SleepCounter = 30
...
Try 
{
	...
	$Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\Sysinternals.lnk")
	$Shortcut.TargetPath = "C:\ProgramData\chocolatey\lib\sysinternals\tools"
	$Shortcut.Save()
}
Catch 
{
