...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\ida64.lnk")
    $Shortcut.TargetPath = "C:\Program Files\IDA Freeware 7.0\ida64.exe"
    $Shortcut.Save()
}
Catch 
{
