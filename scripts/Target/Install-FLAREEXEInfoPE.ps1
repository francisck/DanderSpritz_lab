<#  
    .SYNOPSIS  
    Installs EXEinfoPE from the Internet via Chocolatey. 
    ...
    Performs a standard chocolatey installation of the most recent stable version of EXEInfoPE. 
...
Try 
{
    ...
    $Shortcut = $WshShell.CreateShortcut("$Home\Desktop\tools\ExeinfoPe.lnk")
    $Shortcut.TargetPath = "C:\ProgramData\chocolatey\lib\exeinfope\tools\ExeinfoPe\exeinfope.exe"
    $Shortcut.Save()
}
Catch 
{
